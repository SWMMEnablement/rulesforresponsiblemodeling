  ...
  return (
    <Card className="p-6 sm:p-8">
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
            <span className="font-medium text-foreground">Calibration Parameters</span>
      ...
      <div className="h-[300px] sm:h-[350px] mb-6">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={chartData} margin={{ top: 10, right: 20, left: 0, bottom: 5 }}>
            ...
            <Tooltip formatter={(value: number) => [`${value}%`, "Reliability"]} labelFormatter={(v) => `${v} subcatchments`} />
      ...
      <div className={`flex items-start gap-3 p-4 rounded-lg ${zoneInfo.bg}`}>
        ...
        <div>
          <p className={`font-semibold text-sm ${zoneInfo.color}`}>{zoneInfo.label} — Reliability: {currentReliability}%</p>
