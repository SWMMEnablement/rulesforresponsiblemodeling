...
const improvements = [
  ...
  },
  {
    ...
    status: "implemented" as const,
    description: "Fuse.js-powered full-text search across all chapter content, concepts, rules, and principles via the Command Palette (⌘K).",
    impact: "Transforms the app from a browsable book into a searchable knowledge base. Modelers find concepts by keyword, not chapter number.",
    link: "/",
  },
  {
    number: 5,
    ...
    status: "implemented" as const,
    description: "A comprehensive progress tracking page showing chapters engaged, flashcard SM-2 stats, pathway completion, quiz scores, and bookmarks.",
    impact: "Gives returning users an immediate on-ramp and creates a sense of progression through the 15-20 hour learning experience.",
    link: "/progress",
  },
  {
    number: 6,
    title: "Print-Friendly Chapter Views",
    status: "implemented" as const,
    description: "Print button in chapter headers with CSS @media print styles that hide navigation, format for paper, and add page headers.",
    impact: "Modelers print chapters for commutes, meetings, or hand-annotation. Professional output on any printer.",
    link: "/chapter/1",
  },
  {
    number: 7,
    title: "Share-This-Rule Links",
    status: "implemented" as const,
    description: "Share buttons on rules with pre-formatted text for LinkedIn, Twitter, email, and clipboard. Each rule becomes a shareable artifact.",
    impact: "When a senior engineer wants to correct a junior's approach, they share the link instead of writing an email.",
    link: "/chapter/17",
  },
  {
    number: 8,
    title: "Custom OG / Social Share Image",
    status: "implemented" as const,
    description: "Branded social sharing image with the complexity-reliability curve — the book's most iconic diagram — replacing the default Lovable image.",
    impact: "Every share on LinkedIn, Twitter, or Slack is now a visual advertisement for the app.",
  },
  {
    number: 9,
