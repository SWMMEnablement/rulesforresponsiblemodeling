    ...
    <>
      ...
      <div className="space-y-12">
        <div className="flex justify-center mb-8">
          <SoftwareExamples chapterNumber={15} />
        </div>
        <section>
...
graph LR
    ...
    style D fill:#f59e0b,stroke:#d97706,color:#fff
        ...
        {/* Modern Annotations */}
        {chapterAnnotations[15] && (
          <section>
            <ModernAnnotation annotations={chapterAnnotations[15]} />
          </section>
        )}

        {/* Application Challenge */}
        {chapterChallenges[15] && (
          <section>
            <ApplicationChallenge challenge={chapterChallenges[15]} />
          </section>
        )}
